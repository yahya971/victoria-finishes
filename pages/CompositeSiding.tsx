...
import { COMPOSITE_SIDING_BENEFITS } from '../data/compositeSidingData';
import BenefitIcon from '../components/BenefitIcon';
import ProductGallery from '../components/ProductGallery';
import { COMPOSITE_SIDING_GALLERY_IMAGES } from '../utils/compositeSidingImages';
import { getAssetPath } from '../utils/paths';

const CompositeSiding: React.FC = () => {
  const navigate = useNavigate();

  // Prepare gallery images
  const galleryImages = COMPOSITE_SIDING_GALLERY_IMAGES.map(name => ({
    filename: name,
    category: 'All'
  }));
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 md:pt-40 pb-20 md:pb-32 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            >
              LONG LASTING PROTECTION<br />WITH MODERN DESIGN
            </motion.h2>
            ...
            >
              Our WPC composite siding is a durable, low-maintenance solution designed for outdoor façades. It delivers the look of natural wood while offering long-term resistance to weather, moisture, and wear, without the need for ongoing upkeep.
            </motion.p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-32 flex items-center justify-center overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: `url("${getAssetPath('/assets/Composite-Siding/Composite-Siding-3.jpg')}")`,
          }}
        >
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <div className="space-y-6 text-lg md:text-xl text-white/95 leading-relaxed">
              ...
              >
                Transform your building's exterior with siding that combines the beauty of natural wood with the durability of advanced composite materials. Perfect for residential and commercial façades that demand lasting protection and modern style.
              </motion.p>
            </div>
          </motion.div>
        </div>
          ...
          <div className="relative min-h-[280px]">
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                {COMPOSITE_SIDING_BENEFITS.map((benefit, index) => (
                  <motion.div
                    key={index}
                    ...
                    className={`group relative bg-gradient-to-br from-white to-gray-50 p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 ${
                      index === COMPOSITE_SIDING_BENEFITS.length - 1 && COMPOSITE_SIDING_BENEFITS.length % 3 === 2 ? 'lg:col-start-2' : ''
                    }`}
                  >
      ...
      <ProductGallery
        ...
        subtitle="Browse our collection of composite siding installations showcasing exterior façade solutions"
        filters={['All']}
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto text-lg">
              Book a consultation with our experts to discuss your project and explore our Composite Siding solutions.
            </p>
            <button
...
export default CompositeSiding;
